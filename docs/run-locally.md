...
Once you set your root domain as `captain.local`, use `caprover login` and enter `captain.captain.local` as your captain URL and captain42 as your password. 
