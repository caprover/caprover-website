...
export function ComparisonHubPage({
  ...
  return (
    <ComparePage locale={locale} path={routes.comparisonHub.path}>
      ...
      <section className="compare-section compare-soft">
        <div className="compare-shell">
          <div className="compare-heading">
            <p className="compare-kicker">{copy.shortVersion.kicker}</p>
            <h2>{copy.shortVersion.title}</h2>
            <p>{copy.shortVersion.description}</p>
          </div>
      ...
      <section className="compare-section compare-shell">
        <div className="compare-heading">
          <p className="compare-kicker">{copy.oneOnOne.kicker}</p>
          <h2>{copy.oneOnOne.title}</h2>
          <p>{copy.oneOnOne.description}</p>
        </div>
      ...
      <section className="compare-section compare-shell">
        <SourceLinks locale={locale}>
          ...
          <li>
            <a href={docsUrl("one-click-apps", locale)}>
              {sources.oneClickApps}
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="https://docs.dokploy.com/docs/core">
              {sources.dokployDocs}
            </a>
          </li>
          <li>
            <a href="https://docs.dokploy.com/docs/core/installation">
              {sources.dokployInstallation}
            </a>
          </li>
          <li>
            <a href="https://dokku.com/docs/">{sources.dokkuDocs}</a>
          </li>
          <li>
            <a href="https://dokku.com/docs/getting-started/installation/">
              {sources.dokkuInstallation}
            </a>
          </li>
          <li>
            <a href="https://pro.dokku.com/docs/getting-started/">
              {sources.dokkuPro}
            </a>
          </li>
          <li>
            <a href="https://coolify.io/docs">{sources.coolifyDocs}</a>
          </li>
          <li>
            <a href="https://coolify.io/docs/get-started/installation">
              {sources.coolifyInstallation}
            </a>
          </li>
        </SourceLinks>
      </section>
