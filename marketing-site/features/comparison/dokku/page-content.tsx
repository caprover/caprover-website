...
export function DokkuComparisonPage({
    ...
    <ComparePage locale={locale} path={routes.dokku.path}>
      ...
      <section className="compare-section compare-soft">
        <div className="compare-shell">
          ...
          <PairwiseTable
            competitorName={copy.tableCompetitorName}
      ...
      <section className="compare-section compare-shell">
        <MatchupLinks current="dokku" locale={locale} />
        <SourceLinks locale={locale}>
          <li>
            <a href={docsUrl("get-started", locale)}>{sources.installation}</a>
          </li>
          <li>
            <a href={docsUrl("cli-commands", locale)}>{sources.cli}</a>
          </li>
          <li>
          ...
          <li>
            <a href="https://dokku.com/docs/deployment/methods/git/">
              {sources.competitorGit}
            </a>
          </li>
          <li>
            <a href="https://dokku.com/docs/deployment/schedulers/k3s/">
              {sources.competitorK3s}
            </a>
          </li>
          <li>
            <a href="https://pro.dokku.com/docs/getting-started/">
              {sources.competitorPro}
            </a>
          </li>
        </SourceLinks>
      </section>
