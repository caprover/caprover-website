...
export function DokkuComparisonPage({ locale = DEFAULT_LOCALE }: { locale?: Locale }) {
  ...
  return (
    <ComparePage locale={locale}>
      ...
      <section className="compare-section compare-soft"><div className="compare-shell"><div className="compare-heading"><p className="compare-kicker">{copy.capabilityKicker}</p><h2>{copy.capabilityTitle}</h2></div><ComparisonPrinciples locale={locale} /><PairwiseTable competitorName={copy.tableCompetitorName} rows={copy.rows as PairwiseRow[]} locale={locale} /></div></section>
