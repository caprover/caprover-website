...
export function CoolifyComparisonPage({ locale = DEFAULT_LOCALE }: { locale?: Locale }) {
  ...
  return (
    <ComparePage locale={locale}>
      ...
      <section className="compare-section compare-shell"><MatchupLinks current="coolify" locale={locale} /><SourceLinks locale={locale}>
        ...
        <li><a href="https://coolify.io/docs/get-started/installation">{sources.competitorInstallation}</a></li>
        <li><a href="https://coolify.io/docs/applications/build-packs/docker-compose">{sources.compose}</a></li>
        <li><a href="https://coolify.io/docs/knowledge-base/server/openssh">{sources.servers}</a></li>
        <li><a href="https://coolify.io/docs/knowledge-base/docker/swarm">{sources.swarm}</a></li>
      </SourceLinks></section>
    </ComparePage>
  );
}
